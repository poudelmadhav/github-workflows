...
| -------------- | -------- | ------- | -------------------------------------------------------------- |
| `ruby_version` | no       | —       | Ruby version (e.g. `3.2.6`, `4.0`). Falls back to `.ruby-version` file contents, then to `4.0`. |
...
2. **Resolve Ruby version** — If `ruby_version` input is empty, check for `.ruby-version` file. Read it if found. Otherwise default to `4.0`.
